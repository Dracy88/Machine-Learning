			...
			try {
				...
				while (strLinea!=null){	
					...
					if (strResult!=""){
						...
						totReview++;
						MySQLAccess.push("INSERT INTO db_tripadvisor.tb_result_demo (review, estimate_overall_bernulli, estimate_overall_multinomial) VALUES "
							+ "('" + strResult + "', " + Gadget.estimateOverall(nbClassifierMultinomial(matrixDistributions, wordX, totWords)) + ", " + Gadget.estimateOverall(nbClassifierBernulli(matrixDistributions, arrToBin(wordX), totWords)) + ")");                                             
